 ...
 */
package org.camp.SpecificRecordUpdate;
 ...
 * @author guest1Day
 */
public class SpecificRecordUpdate {
    public static void main (String[] args){
        ...
        try
        {
            ...
            db_st = db_con.prepareStatement("UPDATE profiles SET Name = '田中 太郎',tel='012-7777-7777' WHERE profilesID = 1;");
            db_st.executeUpdate();
